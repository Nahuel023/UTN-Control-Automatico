...
%======================================================================
%% SECCIÓN OPCIONAL: NOTAS DEL CAPÍTULO
%% Usar cuando el capítulo necesita profundizar sin extender el cuerpo
%% principal. Incluye: demostraciones detalladas, historia adicional,
%% conexiones con temas avanzados, referencias con comentarios.
%======================================================================
% \section*{Notas del Capítulo}
% \addcontentsline{toc}{section}{Notas del Capítulo~\thechapter}
%
% \textbf{Nota [N.1] — [Título de la nota].}
% [Desarrollo extendido de un concepto que sería demasiado denso en el
%  cuerpo principal. Puede incluir demostraciones, derivaciones
%  alternativas o contexto histórico.]
%
% \textbf{Nota [N.2] — [Título].}
% [...]
%
%% Para derivaciones muy largas o tablas extensas, crear un apéndice:
%% Ver appendix/apXX_nombre.tex e incluirlo en main.tex bajo \appendix

%======================================================================
%% LECTURAS RECOMENDADAS (opcional al final del capítulo)
%======================================================================
% \subsection*{Lecturas recomendadas}
% Para profundizar en los temas de este capítulo se recomienda:
% \begin{itemize}
%   \item \textcite{ogata2010}, cap. [X]: [tema específico].
%   \item \textcite{nise2019}, cap. [Y]: [tema específico].
%   \item \textcite{franklin2015}, cap. [Z]: [tema específico].
% \end{itemize}
